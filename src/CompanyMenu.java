...
public class CompanyMenu {
    ...
    while (true) {
        ...
        if (command == 1) {
            ...
            System.out.println();
            if(employee==null){
                System.out.println("Смена не возможна.");
                System.out.println();
                return;
            }
            System.out.println("Хотите ли вы назначить данного работника на место руководителя? \n1: ДА \n2: НЕТ");
            int num = in.nextInt();
            if(num==1){
                company.setDirector(employee.getName());
                System.out.println("Вы назначили нового руководителя.");
            }else{
                System.out.println("Вы отменили смену руководителя компании.");
                System.out.println();
            }
